...
describe('mostProfitableDepartment', function(){
    it('to determine which of their departments are the most profitable',function(){
        assert.equal('Thursday', mostProfitableDepartment(salesData), "Most profitable department is 'outdoor' for dataset 1");
    });

    it('to determine which of their departments are the most profitable',function(){
        assert.equal('Wednesday', mostProfitableDepartment(salesData2), "Most profitable department is 'electronics' for dataset 2");
    });
});